...
#
# Modifications: orchestrates the model-specific scripts in a unified run.
...
from scripts.runs.run_timesfm_m4 import evaluate_timesfm_m4_uni2ts
from scripts.runs.run_chronos_m4 import evaluate_chronos_m4_uni2ts
from scripts.runs.run_moirai_m4 import evaluate_moirai_m4_uni2ts
...
if __name__ == "__main__":
    ...
    param_tag = (
        f"c{args.context_len}_b{args.batch_size}_cs{args.chronos_samples}"
        f"_ms{args.moirai_samples}_mb{args.moirai_batch}"
    )
