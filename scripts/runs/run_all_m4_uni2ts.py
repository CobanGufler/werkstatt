...
if __name__ == "__main__":
    ...
    parser.add_argument("--chronos_ckpt", type=str, default="amazon/chronos-t5-base") #"amazon/chronos-t5-tiny"
    parser.add_argument("--moirai_repo", type=str, default="Salesforce/moirai-1.0-R-base") #"Salesforce/moirai-1.0-R-small"
    ...
    param_tag = f"c{args.context_len}_b{args.batch_size}_cs{args.chronos_samples}_ms{args.moirai_samples}_mb{args.moirai_batch}"
